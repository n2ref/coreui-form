document.addEventListener('DOMContentLoaded', function () {
    ...
    let readonlyOptions = {
        ...
        controls: [
            ...
            { type: "button", content: "Text writable", onClick: function (form, e) { form.getField('text').readonly(false); }, attr: { class: 'btn btn-sm btn-success' } },
            { type: "button", content: "Text readonly", onClick: function (form, e) { form.getField('text').readonly(true); },  attr: { class: 'btn btn-sm btn-success' } }
        ]
    };
    ...
    let methodsOptions = {
        ...
        controls: [
            ...
            { type: "button", content: "getFields (log)",   onClick: function (form) { console.log(form.getFields()) }, attr: { class: 'btn btn-sm btn-dark' } },
            { type: "button", content: "getField (log)",    onClick: function (form) { console.log(form.getField('text')) }, attr: { class: 'btn btn-sm btn-dark' } },
            { type: "button", content: "getControls (log)", onClick: function (form) { console.log(form.getControls()) }, attr: { class: 'btn btn-sm btn-dark' } },
            { type: "button", content: "getGroups (log)",   onClick: function (form) { console.log(form.getGroups()) }, attr: { class: 'btn btn-sm btn-dark' } },
        ]
    };
