<?php
namespace CoreUI\Form\Classes\Control\Wysiwyg;
use CoreUI\Form\Classes\Control\Wysiwyg;
...
class Ckeditor extends Wysiwyg {
    ...
    protected function makeControl() {
        ...
        $tpl = file_get_contents(__DIR__ . '/../../../html/form/controls/wysiwyg/ckeditor.html');
