...
CoreUI.form.fields.custom={_id:"",_hash:"",_form:null,_value:null,_options:{type:"custom",label:null,labelWidth:null,width:null,content:"",outContent:null,description:null,required:null,show:!0,column:null},init:function(t,e,n){this._form=t,this._id=t.getId()+"-field-"+(e.hasOwnProperty("name")?e.name:n),this._value=CoreUI.form.utils.getFieldValue(t,e),this._options=CoreUI.form.utils.mergeFieldOptions(t,this._options,e),this._hash=CoreUI.form.utils.hashCode()},getOptions:function(){return $.extend(!0,{},this._options)},readonly:function(t){},hide:function(t){$("#coreui-form-"+this._id).hide(t)},show:function(t){$("#coreui-form-"+this._id).show(t)},getValue:function(){},setValue:function(t){},render:function(){var t=this.getOptions(),e=CoreUI.form.utils.getAttacheFields(this._form,t);return CoreUI.form.ejs.render(CoreUI.form.tpl["form-field-label.html"],{id:this._id,form:this._form,hash:this._hash,field:t,content:this.renderContent(),attachFields:e})},renderContent:function(){var e=this.getOptions();let t="";var n=["coreui.table","coreui.layout","coreui.panel","coreui.tabs","coreui.alert","coreui.chart"];if("string"==typeof e.content)t=e.content;else if(e.content instanceof Object){Array.isArray(e.content)||(e.content=[e.content]);var o,r=[];for(let t=0;t<e.content.length;t++)"string"==typeof e.content[t]?r.push(e.content[t]):!Array.isArray(e.content[t])&&e.content[t].hasOwnProperty("component")&&0<=n.indexOf(e.content[t].component)&&(o=e.content[t].component.split(".")[1],CoreUI.hasOwnProperty(o))&&"object"==typeof CoreUI[o]&&null!==CoreUI[o]&&!Array.isArray(CoreUI[o])&&(o=CoreUI[o].create(e.content[t]),r.push(o.render()),this._form.on("shown.coreui.form",o.initEvents,o,!0));t=r.join("")}return CoreUI.form.ejs.render(CoreUI.form.tpl["fields/custom.html"],{content:t})}};;
